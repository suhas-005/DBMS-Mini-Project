                            ...
                            <center>
                                <div class="row uniform">
                                    <div class="6u 12u$(large)">
                                        <a href="favorites.php?flag=1&pid=<?= $pid; ?>" class="btn btn-primary" style="text-decoration: none;"><span class="glyphicon glyphicon-shopping-cart"> AddToFavourites</a>
                                    </div>
                                    <div class="6u 12u$(large)">
