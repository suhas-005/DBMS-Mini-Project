...
<html lang="en">
	...
	<body>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">FarmEasy &copy; </h3>
			<br />
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">FarmEasy Office<span>Vormir</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:FarmEasy@gmail.com" style="color:white">FarmEasy@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About FarmEasy</b></span>
				FarmEasy is e-commerce trading platform for grocerries...
			</p>
